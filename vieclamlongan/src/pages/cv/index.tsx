        ...
        <Page className="relative flex-1 flex flex-col pb-[66px] bg-white">
            ...
            <Box p={4}>
                <Box>
                    ...
                    <p className="text-[14px] leading-[22px] text-center mb-4 px-4">
                        Tạo mẫu CV nhanh chóng và miễn phí, để nhà tuyển dụng phải
                        "Wow!" ngay khi nhìn thấy CV của bạn.
                    </p>
                    <div className="flex items-center justify-center">
                        <p className="text-[14px] leading-[22px] text-center">Truy cập website: <em>vieclamlongan.vn/danh-sach-cv</em> để thực hiện chức năng <span className="font-semibold">Tạo cv</span>.</p>
                    </div>
                ...
                <Box mt={10}>
                    ...
                    <p className="text-[14px] leading-[22px] text-center mb-4">
                ...
                <Box mt={10}>
                    ...
                    <Box>
                        <div className="text-[14px] leading-[22px] mb-2">
