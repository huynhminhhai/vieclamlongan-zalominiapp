...
const QAItem: React.FunctionComponent = () => {
    ...
    return (
        <Box className="border-b-[1px]" pb={6} mb={6} onClick={() => navigate('/qa-detail?id=1')}>
            <h4 className="text-[16px] leading-[30px] font-semibold mb-3">
            ...
            <Box>
                <Box>
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-1 text-[14px] leading-[14px] text-[#767A7F]">
                ...
                <Box>
                    <div className="text-[13px] text-[#767A7F] leading-[20px] line-clamp-3">
