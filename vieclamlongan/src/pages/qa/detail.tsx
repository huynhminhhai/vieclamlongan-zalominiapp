            ...
            <Box>
                <Box p={4} className="bg-white">
                    <Box pb={2}>
                        ...
                        <h4 className="text-[20px] leading-[30px] font-semibold mb-3 border-b-[1px] pb-3">
                            Tham gia chương trình bảo hiểm?
                        </h4>
                        <Box>
                            <div className="text-[18px] text-[#767A7F] leading-[24px]">
                ...
                <Box p={4} className="bg-white">
                    <Box pb={2}>
                        <Box>
                            <div className="flex items-center justify-between mb-2">
                                <h4 className="text-[20px] leading-[30px] font-semibold">
                                    Trả lời câu hỏi
                                </h4>
                                <div className="flex items-center gap-1 text-[16px] leading-[16px] text-[#767A7F]">
